...
module.exports = {
  nodePath: {
    ...
    description: unwrap`
      Path to the Node executable used to start the language server. This is
      needed because Electron's native Node currently doesn't have enough
      support for dynamic imports to support loading svelte.config.js in
